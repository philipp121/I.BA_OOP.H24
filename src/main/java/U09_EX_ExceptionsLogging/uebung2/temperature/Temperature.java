package U09_EX_ExceptionsLogging.uebung2.temperature;
...
public final class Temperature implements Comparable<Temperature>{
    ...
    /**
     * Get a new temperature set from Celsius
     * @param celsius temperature in celsius
     */
    public static Temperature createTemperatureFromCelsius(final double celsius) {
     ...
     */
    public static Temperature createTemperatureFromKelvin(final double kelvin) {
     ...
     */
    public static Temperature createTemperatureFromFahrenheit(final double fahrenheit) {
