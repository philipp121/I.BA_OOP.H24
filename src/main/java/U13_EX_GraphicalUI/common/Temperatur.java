 ...
 */
package U13_EX_GraphicalUI.common;
...
public final class Temperatur implements Comparable<Temperatur> {
     ...
     * @throws NullPointerException bei ungültigem Temperaturobjekt.
     */
    ...
    public boolean equals(final Object object) {
        return (object == this) || ((object instanceof Temperatur t) && (Float.compare(t.kelvin, this.kelvin) == 0));
    }

    @Override
    public int hashCode() {
        return Objects.hashCode(this.kelvin);
    }
     ...
     * @throws IllegalArgumentException bei ungültigem Temperaturwert.
     */
