...
class TemperatureHistoryTest {
    ...
    private U08_EX_CollectionsEnumsStatic.temperatur.temperature.TemperatureHistory temperatureHistory;
    @BeforeEach
    void setUp() {
        // Initialize a new TemperatureHistory instance before each test
        temperatureHistory = new U08_EX_CollectionsEnumsStatic.temperatur.temperature.TemperatureHistory();
    }
    ...
    void getTemperatures_immutableList() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10));
        List<U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature> temps = temperatureHistory.getTemperatures();
        assertThrows(UnsupportedOperationException.class, () -> temps.add(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20)));
    }

    @Test
    void addTemperature_single() {
        // Verify that a single temperature is added correctly
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(25));
        assertEquals(1, temperatureHistory.getCount());
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(25), temperatureHistory.getTemperatures().getFirst());
    }
    ...
    void addTemperature_multiple() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10));
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20));
        assertEquals(2, temperatureHistory.getCount());
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10), temperatureHistory.getTemperatures().get(0));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20), temperatureHistory.getTemperatures().get(1));
    }

    @Test
    void addTemperature_duplicate() {
        // Verify that duplicate temperatures can be added
        U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature temp = new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(30);
    ...
    void replaceTemperatures_nullThrowsExceptionDoesNotModify() {
        ...
        assertEquals(1, temperatureHistory.getCount());
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10), temperatureHistory.getTemperatures().getFirst());
    }

    @Test
    void addTemperatures_largeList() {
        // Verify that a large list of temperatures can be added efficiently
        List<U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature> largeList = new ArrayList<>();
        for (int i = 0; i < 1_000_000; i++) {
            largeList.add(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(i));
        }
        temperatureHistory.addTemperatures(largeList);
        assertEquals(1_000_000, temperatureHistory.getCount());
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(999_999), temperatureHistory.getMaxTemperature());
    }
    ...
    void clear_singleElementHistory() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(15));
        temperatureHistory.clear();
        assertEquals(0, temperatureHistory.getCount());
        assertTrue(temperatureHistory.getTemperatures().isEmpty());
    }
    ...
    void clear_multipleElementsHistory() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10));
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20));
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(30));
        temperatureHistory.clear();
        assertEquals(0, temperatureHistory.getCount());
        assertTrue(temperatureHistory.getTemperatures().isEmpty());
    }
    ...
    void clear_andAddNewTemperatures() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20));
        assertEquals(1, temperatureHistory.getCount());
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20), temperatureHistory.getTemperatures().getFirst());
    }
    ...
    void addTemperatures_singleElement() {
        ...
        List<U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature> newTemps = List.of(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(15));
        temperatureHistory.addTemperatures(newTemps);
        assertEquals(1, temperatureHistory.getCount());
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(15), temperatureHistory.getTemperatures().getFirst());
    }

    @Test
    void addTemperatures_multipleElements() {
        // Verify that adding a list with multiple elements works correctly
        List<U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature> newTemps = List.of(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10), new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20));
        temperatureHistory.addTemperatures(newTemps);
        assertEquals(2, temperatureHistory.getCount());
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10), temperatureHistory.getTemperatures().get(0));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20), temperatureHistory.getTemperatures().get(1));
    ...
    void getMax_Temperature_singleElement() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(15));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(15), temperatureHistory.getMaxTemperature());
    }
    ...
    void getMax_Temperature_multipleElements() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10));
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20));
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(5));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20), temperatureHistory.getMaxTemperature());
    }

    @Test
    void getMax_Temperature_withNegativeTemperatures() {
        // Verify that getMaxTemperature() works correctly with negative temperatures
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(-100));
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(-273));
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(0));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(0), temperatureHistory.getMaxTemperature());
    }
    ...
    void getMax_Temperature_withDuplicates() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10));
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10), temperatureHistory.getMaxTemperature());
    }

    @Test
    void getMax_Temperature_withEdgeCases() {
        // Verify that getMaxTemperature() works correctly with extreme values
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature.KELVIN_OFFSET));
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(Integer.MAX_VALUE));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(Integer.MAX_VALUE), temperatureHistory.getMaxTemperature());
    }
    ...
    void getMax_Temperature_largeList() {
        ...
        for (int i = 1; i <= 1_000_000; i++) {
            temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(i));
        }
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(1_000_000), temperatureHistory.getMaxTemperature());
    }
    ...
    void getMin_Temperature_singleElement() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(15));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(15), temperatureHistory.getMinTemperature());
    }
    ...
    void getMin_Temperature_multipleElements() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20));
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(5));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(5), temperatureHistory.getMinTemperature());
    }
    ...
    void getMin_Temperature_withNegativeTemperatures() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(-273));
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(0));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(-273), temperatureHistory.getMinTemperature());
    }
    ...
    void getMin_Temperature_withDuplicates() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10));
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10), temperatureHistory.getMinTemperature());
    }
    ...
    void getMin_Temperature_withEdgeCases() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature.KELVIN_OFFSET));
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(Integer.MAX_VALUE));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature.KELVIN_OFFSET), temperatureHistory.getMinTemperature());
    }
    ...
    void getMin_Temperature_largeList() {
        ...
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(1), temperatureHistory.getMinTemperature());
    }

    @Test
    void getAverageTemperature_emptyHistory() {
        // Verify that getAverageTemperature() returns null for an empty history
        U08_EX_CollectionsEnumsStatic.temperatur.temperature.TemperatureHistory history = new U08_EX_CollectionsEnumsStatic.temperatur.temperature.TemperatureHistory();
    ...
    void getAverageTemperature_singleElement() {
        ...
        U08_EX_CollectionsEnumsStatic.temperatur.temperature.TemperatureHistory history = new U08_EX_CollectionsEnumsStatic.temperatur.temperature.TemperatureHistory();
        history.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(25));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(25), history.getAverageTemperature());
    }
    ...
    void getAverageTemperature_multipleElements() {
        ...
        U08_EX_CollectionsEnumsStatic.temperatur.temperature.TemperatureHistory history = new U08_EX_CollectionsEnumsStatic.temperatur.temperature.TemperatureHistory();
        history.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10));
        history.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20));
        history.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(30));
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20), history.getAverageTemperature());
    }
    ...
    void getAverageTemperature_largeList() {
        ...
        assertEquals(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(500_000.5), temperatureHistory.getAverageTemperature());
    }
    ...
    void testEqualsContract() {
        ...
        EqualsVerifier.forClass(U08_EX_CollectionsEnumsStatic.temperatur.temperature.TemperatureHistory.class).verify();
    }
    ...
    void equals_sameObjects() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10));
        U08_EX_CollectionsEnumsStatic.temperatur.temperature.TemperatureHistory other = new U08_EX_CollectionsEnumsStatic.temperatur.temperature.TemperatureHistory();
        other.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10));
    ...
    void equals_differentObjects() {
        ...
        temperatureHistory.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(10));
        U08_EX_CollectionsEnumsStatic.temperatur.temperature.TemperatureHistory other = new U08_EX_CollectionsEnumsStatic.temperatur.temperature.TemperatureHistory();
        other.addTemperature(new U08_EX_CollectionsEnumsStatic.temperatur.temperature.Temperature(20));
